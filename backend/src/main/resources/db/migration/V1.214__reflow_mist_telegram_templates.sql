-- Reflow Mist notifications into one compact, sectioned layout.
-- Template variables and notification codes remain unchanged.
...
${overview}',
    `update_datetime` = NOW(),
    `update_user_name` = 'system'
WHERE `template_code` IN ('media_photo_message', 'media_text_message')
...
UPDATE `notify_template`
SET `template_content` = '*🌁 MIST / 播放开始*
┄┄┄┄┄┄┄┄┄┄┄┄
...
UPDATE `notify_template`
SET `template_content` = '🌁 <b>MIST / Emby 客户端拦截</b>
┄┄┄┄┄┄┄┄┄┄┄┄
