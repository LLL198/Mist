...
public class HostLineSave implements Serializable {
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof HostLineSave other)) {
         return false;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof HostLineSave;
   }
   ...
   public String toString() {
      return "HostLineSave(embyInfoId="
         + this.getEmbyInfoId()
         + ", lineName="
         + this.getLineName()
         + ", lineType="
