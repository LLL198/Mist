package com.una.embyhub.model.dto.response.mediaviewdetail;

import java.io.Serializable;
import java.util.Date;
import lombok.Generated;

public class MediaViewDetailResponse implements Serializable {
   private Long id;
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof MediaViewDetailResponse other)) {
         return false;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof MediaViewDetailResponse;
   }
   ...
   public String toString() {
      return "MediaViewDetailResponse(id="
         + this.getId()
         + ", mediaId="
         + this.getMediaId()
         + ", userId="
