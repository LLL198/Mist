...
public class PlaybackRankingConfigResponse {
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof PlaybackRankingConfigResponse other)) {
         return false;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof PlaybackRankingConfigResponse;
   }
   ...
   public String toString() {
      return "PlaybackRankingConfigResponse(embyInfoId="
         + this.getEmbyInfoId()
         + ", serverName="
         + this.getServerName()
         + ", excludedUserIds="
