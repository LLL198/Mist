...
public class PointsBotPrizeConfigUpdate implements Serializable {
   @NotNull(
      message = "奖品配置ID不能为空"
   )
   private Long id;
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof PointsBotPrizeConfigUpdate other)) {
         return false;
   ...
   public String toString() {
      return "PointsBotPrizeConfigUpdate(id="
         + this.getId()
         + ", prizeName="
         + this.getPrizeName()
         + ", requiredPoints="
