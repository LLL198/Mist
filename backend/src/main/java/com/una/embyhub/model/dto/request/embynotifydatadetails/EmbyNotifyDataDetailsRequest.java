...
public class EmbyNotifyDataDetailsRequest implements Serializable {
   private Long id;
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof EmbyNotifyDataDetailsRequest other)) {
         return false;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof EmbyNotifyDataDetailsRequest;
   }
   ...
   public String toString() {
      return "EmbyNotifyDataDetailsRequest(id="
         + this.getId()
         + ", embyNotifyDataId="
