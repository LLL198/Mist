...
public class RequestPackagesCardSecurityManagementUpdate implements Serializable {
   private Long id;
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof RequestPackagesCardSecurityManagementUpdate other)) {
         return false;
   ...
   public String toString() {
      return "RequestPackagesCardSecurityManagementUpdate(id="
         + this.getId()
         + ", cardPassword="
