...
public class TmdbDailyReleaseResponse implements Serializable {
   private Long id;
   ...
   @Generated
   public void setMediaTypeLabel(final String mediaTypeLabel) {
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof TmdbDailyReleaseResponse other)) {
         return false;
                                          ...
                                          if (this$wechatBotSent == null ? other$wechatBotSent == null : this$wechatBotSent.equals(other$wechatBotSent)) {
                                             ...
                                             if (this$publishDate == null ? other$publishDate == null : this$publishDate.equals(other$publishDate)) {
                                                ...
                                                if (this$mediaType == null ? other$mediaType == null : this$mediaType.equals(other$mediaType)) {
                                                   Object this$mediaTypeLabel = this.getMediaTypeLabel();
                                                   Object other$mediaTypeLabel = other.getMediaTypeLabel();
                                                   if (this$mediaTypeLabel == null
                                                      ? other$mediaTypeLabel == null
                                                      : this$mediaTypeLabel.equals(other$mediaTypeLabel)) {
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof TmdbDailyReleaseResponse;
   }
   ...
   public int hashCode() {
      ...
      Object $mediaTypeLabel = this.getMediaTypeLabel();
      result = result * 59 + ($mediaTypeLabel == null ? 43 : $mediaTypeLabel.hashCode());
   ...
   public String toString() {
      return "TmdbDailyReleaseResponse(id="
         + this.getId()
         + ", publishDate="
         + this.getPublishDate()
         + ", mediaType="
