...
public class RequestPackagesCardSecurityManagementResponse implements Serializable {
   private Long id;
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof RequestPackagesCardSecurityManagementResponse other)) {
         return false;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof RequestPackagesCardSecurityManagementResponse;
   }
   ...
   public String toString() {
      return "RequestPackagesCardSecurityManagementResponse(id="
         + this.getId()
         + ", cardPassword="
