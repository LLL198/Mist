...
public class RequestListAudit implements Serializable {
   @NotEmpty(
      message = "求片列表id不能为空"
   )
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof RequestListAudit other)) {
         return false;
   ...
   public String toString() {
      return "RequestListAudit(requestListIdList="
