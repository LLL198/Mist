...
public class PublicUserRegistrationRequest implements ProtectedUserMutationRequest, Serializable {
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof PublicUserRegistrationRequest other)) {
         return false;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof PublicUserRegistrationRequest;
   }
   ...
   public String toString() {
      return "PublicUserRegistrationRequest(embyUserName="
