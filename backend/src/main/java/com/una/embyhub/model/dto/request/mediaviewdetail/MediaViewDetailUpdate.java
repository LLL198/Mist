...
public class MediaViewDetailUpdate implements Serializable {
   private Long id;
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof MediaViewDetailUpdate other)) {
         return false;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof MediaViewDetailUpdate;
   }
   ...
   public String toString() {
      return "MediaViewDetailUpdate(id="
         + this.getId()
         + ", mediaId="
         + this.getMediaId()
         + ", userId="
