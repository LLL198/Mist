...
public class RoseLibraryBindingResponse implements Serializable {
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof RoseLibraryBindingResponse other)) {
         return false;
   ...
   public String toString() {
      return "RoseLibraryBindingResponse(libraryKey="
         + this.getLibraryKey()
         + ", name="
         + this.getName()
         + ", targetRoot="
