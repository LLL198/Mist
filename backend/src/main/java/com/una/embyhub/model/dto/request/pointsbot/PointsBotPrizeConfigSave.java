...
public class PointsBotPrizeConfigSave implements Serializable {
   @NotBlank(
      message = "奖品名称不能为空"
   )
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof PointsBotPrizeConfigSave other)) {
         return false;
   ...
   public String toString() {
      return "PointsBotPrizeConfigSave(prizeName="
         + this.getPrizeName()
         + ", requiredPoints="
