...
public class NotifyChannelRequest implements Serializable {
   private Long id;
   private String name;
   private String desc;
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof NotifyChannelRequest other)) {
         return false;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof NotifyChannelRequest;
   }
   ...
   public String toString() {
      return "NotifyChannelRequest(id="
         + this.getId()
         + ", name="
         + this.getName()
         + ", desc="
