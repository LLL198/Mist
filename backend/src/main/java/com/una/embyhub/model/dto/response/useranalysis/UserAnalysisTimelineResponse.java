...
public class UserAnalysisTimelineResponse implements Serializable {
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof UserAnalysisTimelineResponse other)) {
         return false;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof UserAnalysisTimelineResponse;
   }
   ...
   public String toString() {
      return "UserAnalysisTimelineResponse(label="
         + this.getLabel()
         + ", count="
         + this.getCount()
