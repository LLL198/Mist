package com.una.embyhub.model.dto.response.requestpackages;
...
public class RequestPackagesResponse implements Serializable {
   private Long id;
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof RequestPackagesResponse other)) {
         return false;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof RequestPackagesResponse;
   }
   ...
   public String toString() {
      return "RequestPackagesResponse(id="
         + this.getId()
         + ", title="
         + this.getTitle()
         + ", description="
