...
public class EmbyUserRegisterRecordRequest implements Serializable {
   @BindQuery(
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof EmbyUserRegisterRecordRequest other)) {
         return false;
   ...
   public String toString() {
      return "EmbyUserRegisterRecordRequest(createDatetimeStart="
