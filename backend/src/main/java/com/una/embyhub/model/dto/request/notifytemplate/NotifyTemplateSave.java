...
public class NotifyTemplateSave implements Serializable {
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof NotifyTemplateSave other)) {
         return false;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof NotifyTemplateSave;
   }
   ...
   public String toString() {
      return "NotifyTemplateSave(templateCode="
