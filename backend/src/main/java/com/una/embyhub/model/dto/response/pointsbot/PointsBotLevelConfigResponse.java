...
public class PointsBotLevelConfigResponse implements Serializable {
   private Long id;
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof PointsBotLevelConfigResponse other)) {
         return false;
   ...
   public String toString() {
      return "PointsBotLevelConfigResponse(id="
         + this.getId()
         + ", levelName="
         + this.getLevelName()
         + ", minPoints="
