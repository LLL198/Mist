...
public class EmbyNotifyDataDetailsUpdate implements Serializable {
   private Long id;
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof EmbyNotifyDataDetailsUpdate other)) {
         return false;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof EmbyNotifyDataDetailsUpdate;
   }
   ...
   public String toString() {
      return "EmbyNotifyDataDetailsUpdate(id="
         + this.getId()
         + ", embyNotifyDataId="
