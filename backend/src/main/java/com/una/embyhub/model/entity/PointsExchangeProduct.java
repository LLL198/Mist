...
@TableName("points_exchange_product")
public class PointsExchangeProduct extends BaseEntity implements Serializable {
   ...
   public String toString() {
      return "PointsExchangeProduct(id="
         + this.getId()
         + ", name="
         + this.getName()
         + ", productType="
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof PointsExchangeProduct other)) {
         return false;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof PointsExchangeProduct;
   }
