...
public class DoubanPageResponse implements Serializable {
   ...
   @Generated
   public void setItems(final List<DoubanSimpleSubjectResponse> items) {
      this.items = items;
   }
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof DoubanPageResponse other)) {
         return false;
   ...
   public String toString() {
      return "DoubanPageResponse(page="
         + this.getPage()
         + ", pageSize="
         + this.getPageSize()
         + ", total="
