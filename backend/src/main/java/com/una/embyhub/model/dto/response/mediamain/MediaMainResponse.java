...
public class MediaMainResponse implements Serializable {
   private Long id;
   ...
   @BindEntityList(
      entity = MediaViewDetail.class,
      condition = "this.id=media_id"
   )
   ...
   @Generated
   public void setMediaViewDetailResponseList(final List<MediaViewDetailResponse> mediaViewDetailResponseList) {
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof MediaMainResponse other)) {
         return false;
                                                   ...
                                                   if (this$updateDatetime == null
                                                      ...
                                                      if (this$createUserName == null
                                                         ...
                                                         if (this$updateUserName == null
                                                            ...
                                                            Object this$mediaViewDetailResponseList = this.getMediaViewDetailResponseList();
                                                            Object other$mediaViewDetailResponseList = other.getMediaViewDetailResponseList();
                                                            return this$mediaViewDetailResponseList == null
                                                               ? other$mediaViewDetailResponseList == null
                                                               : this$mediaViewDetailResponseList.equals(other$mediaViewDetailResponseList);
                                                         } else {
                                                            return false;
                                                         }
                                                      } else {
   ...
   public int hashCode() {
      ...
      Object $mediaViewDetailResponseList = this.getMediaViewDetailResponseList();
      return result * 59 + ($mediaViewDetailResponseList == null ? 43 : $mediaViewDetailResponseList.hashCode());
   }

   @Generated
   @Override
   public String toString() {
      return "MediaMainResponse(id="
         + this.getId()
         + ", title="
         + this.getTitle()
         + ", embyInfoId="
         ...
         + ", delFlag="
         + this.getDelFlag()
         + ", mediaViewDetailResponseList="
         + this.getMediaViewDetailResponseList()
         + ")";
   }
}
