...
public class RequestPackagesUpdate implements Serializable {
   private Long id;
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof RequestPackagesUpdate other)) {
         return false;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof RequestPackagesUpdate;
   }
   ...
   public String toString() {
      return "RequestPackagesUpdate(id="
         + this.getId()
         + ", title="
         + this.getTitle()
         + ", description="
