...
@TableName("emby_client_filter_exclusion_config")
public class EmbyClientFilterExclusionConfig extends BaseEntity implements Serializable {
   @TableId(
      value = "id",
      type = IdType.AUTO
   )
   ...
   public String toString() {
      return "EmbyClientFilterExclusionConfig(id="
         + this.getId()
         + ", embyInfoId="
         + this.getEmbyInfoId()
         + ", excludedUserIds="
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof EmbyClientFilterExclusionConfig other)) {
         return false;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof EmbyClientFilterExclusionConfig;
   }
