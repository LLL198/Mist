...
public class EmbyClientFilterExclusionSummaryResponse {
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof EmbyClientFilterExclusionSummaryResponse other)) {
         return false;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof EmbyClientFilterExclusionSummaryResponse;
   }
   ...
   public String toString() {
      return "EmbyClientFilterExclusionSummaryResponse(excludedUserIdsByServer=" + this.getExcludedUserIdsByServer() + ")";
   }
}
