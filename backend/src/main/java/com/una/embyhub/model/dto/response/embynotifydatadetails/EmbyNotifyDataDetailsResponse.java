...
public class EmbyNotifyDataDetailsResponse implements Serializable {
   private Long id;
   ...
   public void setSize(String size) {
      this.size = DataSizeUtil.format(Long.valueOf(size), DataUnit.GIGABYTES);
   }
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof EmbyNotifyDataDetailsResponse other)) {
         return false;
   ...
   public String toString() {
      return "EmbyNotifyDataDetailsResponse(id="
         + this.getId()
         + ", embyNotifyDataId="
