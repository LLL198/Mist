...
public class NotifyChannelSave implements Serializable {
   private String name;
   private String desc;
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof NotifyChannelSave other)) {
         return false;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof NotifyChannelSave;
   }
