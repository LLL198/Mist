...
public class MoviesReportResponse implements Serializable {
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof MoviesReportResponse other)) {
         return false;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof MoviesReportResponse;
   }
   ...
   public String toString() {
      return "MoviesReportResponse(label=" + this.getLabel() + ", count=" + this.getCount() + ", time=" + this.getTime() + ")";
   }
}
