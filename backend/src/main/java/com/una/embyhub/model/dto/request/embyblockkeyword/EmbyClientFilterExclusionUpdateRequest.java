...
public class EmbyClientFilterExclusionUpdateRequest {
   @NotNull(
      message = "服务器不能为空"
   )
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof EmbyClientFilterExclusionUpdateRequest other)) {
         return false;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof EmbyClientFilterExclusionUpdateRequest;
   }
   ...
   public String toString() {
      return "EmbyClientFilterExclusionUpdateRequest(embyInfoId=" + this.getEmbyInfoId() + ", excludedUserIds=" + this.getExcludedUserIds() + ")";
   }
}
