...
@TableName("emby_client_filter_record")
public class EmbyClientFilterRecord extends BaseEntity implements Serializable {
   private static final long serialVersionUID = 1L;
   public static final String FILTER_TYPE_UA = "UA";
   public static final String FILTER_TYPE_REGION = "REGION";
   @TableId(
      value = "id",
      type = IdType.AUTO
   )
   ...
   @TableField("matched_pattern")
   private String matchedPattern;
   @TableField("using_default_patterns")
   private Integer usingDefaultPatterns;
   @TableField("stop_success")
   private Integer stopSuccess;
   @TableField("message_success")
   private Integer messageSuccess;
   @TableField("block_user_enabled")
   private Integer blockUserEnabled;
   @TableField("block_user_success")
   ...
   public static final String COL_RESOLVED_IP = "resolved_ip";
   ...
   public String toString() {
      return "EmbyClientFilterRecord(id="
         + this.getId()
         + ", embyInfoId="
         + this.getEmbyInfoId()
         + ", embyServerId="
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof EmbyClientFilterRecord other)) {
         return false;
                                                                                       ...
                                                                                       if (this$itemType == null
                                                                                          ...
                                                                                          if (this$matchedPattern == null
                                                                                             ...
                                                                                             if (this$triggerTime == null
                                                                                                ...
                                                                                                Object this$rawPayload = this.getRawPayload();
                                                                                                Object other$rawPayload = other.getRawPayload();
                                                                                                return this$rawPayload == null
                                                                                                   ? other$rawPayload == null
                                                                                                   : this$rawPayload.equals(other$rawPayload);
                                                                                             } else {
                                                                                                return false;
                                                                                             }
                                                                                          } else {
   ...
   public int hashCode() {
      ...
      Object $rawPayload = this.getRawPayload();
      return result * 59 + ($rawPayload == null ? 43 : $rawPayload.hashCode());
   }
}
