...
@TableName("emby_info")
public class EmbyInfo extends BaseEntity implements Serializable {
   ...
   @TableField("emby_open_url")
   private String embyOpenUrl;
   @TableField("emby_port")
   private String embyPort;
   @TableField("emby_agreement")
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof EmbyInfo other)) {
         return false;
