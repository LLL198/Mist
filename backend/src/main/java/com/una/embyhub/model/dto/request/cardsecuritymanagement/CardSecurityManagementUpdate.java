...
public class CardSecurityManagementUpdate implements Serializable {
   private Long id;
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof CardSecurityManagementUpdate other)) {
         return false;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof CardSecurityManagementUpdate;
   }
   ...
   public String toString() {
      return "CardSecurityManagementUpdate(id="
         + this.getId()
         + ", cardPassword="
