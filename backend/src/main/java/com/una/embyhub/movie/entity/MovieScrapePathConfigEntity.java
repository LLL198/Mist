...
@TableName("movie_scrape_path_config")
public class MovieScrapePathConfigEntity extends BaseEntity {
   ...
   public String toString() {
      return "MovieScrapePathConfigEntity(id="
         + this.getId()
         + ", name="
         + this.getName()
         + ", qbDownloadPath="
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof MovieScrapePathConfigEntity other)) {
         return false;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof MovieScrapePathConfigEntity;
   }
