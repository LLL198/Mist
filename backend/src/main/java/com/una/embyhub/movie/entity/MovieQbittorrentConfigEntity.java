...
@TableName("movie_qbittorrent_config")
public class MovieQbittorrentConfigEntity extends BaseEntity implements Serializable {
   ...
   public String toString() {
      return "MovieQbittorrentConfigEntity(id="
         + this.getId()
         + ", host="
         + this.getHost()
         + ", username="
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof MovieQbittorrentConfigEntity other)) {
         return false;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof MovieQbittorrentConfigEntity;
   }
